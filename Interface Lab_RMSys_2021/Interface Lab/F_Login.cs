    ...
    public partial class F_Login : Form
    {
        ...
        private void Load_Permission()
        {
            try
            {
                ...
                string sql6 = "SELECT  Status_Use,UserID FROM [SapthipNewDB].[dbo].[V_Permission] WHERE [User_AD] = '" + Program.user_login + "' AND [ID_Menu]= 8 ";
                ...
                if (Status_Use == 0)
                {
                    MessageBox.Show("สิทธิ์การใช้งานถูกจำกัด กรูณาตรวจสอบกับผู้ดูแลระบบ (เปิดโปรแกรม % แป้งมันสด)", "รายงานความผิดพลาด!!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //Application.Exit();
                }             
            ...
            {
                MessageBox.Show("ไม่มีการเปิดใช้งานเมนูนี้ กรูณาตรวจสอบกับผู้ดูแลระบบ (เปิดโปรแกรม % แป้งมันสด)", "รายงานความผิดพลาด!!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //Application.Exit();
            }
